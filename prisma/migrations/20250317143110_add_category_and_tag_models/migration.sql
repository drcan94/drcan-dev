...
-- Insert default "genel" category
INSERT INTO "Category" ("id", "name", "slug", "createdAt", "updatedAt")
VALUES ('clfgenel123456789', 'Genel', 'genel', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Update existing blog posts to use the default category
UPDATE "BlogPost" SET "categoryId" = 'clfgenel123456789' WHERE "categoryId" IS NULL;

-- Now alter the column to be NOT NULL after all data has been migrated
